    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Student Registration Info</h2>
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="RollId" name="rollid">
                        </div>
                        <div class="input-group">
                        ...
                        <p>Parent's Details</p>
                            <input class="input--style-3" type="text" placeholder="Guardian Name" name="guardian name">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Phone" name="phone">
                        </div>
